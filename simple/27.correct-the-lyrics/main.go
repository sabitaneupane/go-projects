...
var lyrics = strings.Fields(`all my troubles seemed so far away oh I believe in yesterday now it looks as though they are here to stay`)

// func main() {
// 	lyrics = append([]string{"yesterday"}, lyrics...)
// 	lyrics = append(lyrics, lyrics[8:13]...)
// 	lyrics = append(lyrics[:8], lyrics[13:]...)
// 	fmt.Printf("%s\n", lyrics)
// }
